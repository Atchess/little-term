...
public class TodoListAdapter extends RecyclerView.Adapter<TodoListItemHolder> {
    ...
    public TodoListAdapter(TodoListActivity activity) {
    ...
    public TodoListItemHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new TodoListItemHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.todo_item_layout, parent, false), mActivity);
    }
