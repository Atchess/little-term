...
public class MyAdapter extends RecyclerView.Adapter<MyAdapter.MyViewHolder> {
    ...
    public static class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View v) {
            ...
            //tvIndex = v.findViewById(R.id.);
            tvTitle = v.findViewById(R.id.massage_come_from_name);
            tvMassage = v.findViewById(R.id.nearly_massage);
        ...
        public void onBind(int position, TestData data) {
            ...
            tvImage.setImageURI(Uri.parse(data.imageAddress));
            tvImage.setImageResource(R.drawable.ic_launcher_background);
            tvMassage.setText(data.massage);
            /*if (position < 3) {
